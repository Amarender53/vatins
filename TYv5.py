...
telegram_token = os.environ.get("TELEGRAM_TOKEN", "ceb559c6275cfe6fd2297547f0384da3")
...
async def search_results(keywords):
    ...
    results = await DDGS().text(keywords, region=ddg_region, safesearch='off', max_results=3)
    return results
